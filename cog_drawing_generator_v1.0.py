...
def display_combined_cog_details():
    ...
    if all([vc_model, vc_moc, vc_fill_type, vc_eliminators, vc_sweeper_piping, vc_intake, vc_discharge]):
        cog_values = get_cog_mass_values(vc_model, vc_moc, vc_fill_type, vc_eliminators, vc_sweeper_piping, vc_intake, vc_discharge)
...
# Set base PDF file path
base_pdf = r"C:\Users\arul.mohan\OneDrive - MKS VISION PVT LTD\Documents\GitHub\cog\template\COG_VT_1.pdf"
